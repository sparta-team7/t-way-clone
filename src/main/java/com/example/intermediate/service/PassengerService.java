...
public class PassengerService {
  ...
  * */
  ...
  //id에 해당하는 passenger 조회
  @Transactional(readOnly = true)
  public ResponseDto<?> getPassenger(Long id) {
    Passenger passenger = isPresentPassenger(id);
    if (null == passenger) { //해당하는 id의 passenger가 반환되지 않았으면 fail 반환
